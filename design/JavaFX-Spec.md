...
| Core gear i (i=0..C−1) | Cylinder r=4.7 h=6.4 plus 12 radial teeth and dark axle @ (laneX(i), 6, 0) | laneX(i) = (i−(C−1)/2)·min(26,130/(C−1)); C=4 default, clamp 2–10; persistent angle with eased angular velocity |
...
| Core activity i | Toothed core gear plus front piston and rising sparks @ (laneX(i),6,0) | accelerate toward 82–134°/s while working, coast to rest at idle, ease into a slow red stutter while pinned |
