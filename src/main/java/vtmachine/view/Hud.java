...
public final class Hud {
    ...
    private static final String[] CHAPTER_TEXT = {
        ...
        "The payoff. 500 mixed-duration tasks flood in while the camera pulls back and the run queue expands. A fixed carrier pool keeps draining work as parked VTs release their lanes. The finale holds the essential result: hundreds of VTs, only a handful of carrier and OS threads.",
